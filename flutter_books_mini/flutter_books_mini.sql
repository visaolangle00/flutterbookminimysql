...
--
-- Cơ sở dữ liệu: `flutter_books_mini`
--
...
--
-- Cấu trúc bảng cho bảng `book_post`
--
...
--
-- Đang đổ dữ liệu cho bảng `book_post`
--
...
--
-- AUTO_INCREMENT cho bảng `book_post`
--
ALTER TABLE `book_post`
...
--
-- Các ràng buộc cho bảng `book_post`
--
ALTER TABLE `book_post`
